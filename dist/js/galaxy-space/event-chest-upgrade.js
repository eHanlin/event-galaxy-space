    ...
    ajax('GET', `/chest/checkBalance/level${upLevel}`, null)
      ...
      .then(jsonData => {
        ...
        if (memo.levelUpSuccess === "true") {
          title = '升級成功'
          gif = `<image class="confirm-popup-chest-gif" src="https://s3-ap-northeast-1.amazonaws.com/ehanlin-web-resource/event-galaxy-space/img/chest/upgradeStatus/upgradeSuccess${chest.level}.gif">`
        } else {
          title = '升級失敗'
