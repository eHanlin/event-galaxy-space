...
!function (e, t) {
  ...
  var e = { title: "", titleText: "", text: "", html: "", footer: "", type: null, toast: !1, customClass: "", target: "body", backdrop: !0, animation: !0, allowOutsideClick: !0, allowEscapeKey: !0, allowEnterKey: !0, showConfirmButton: !0, showCancelButton: !1, preConfirm: null, confirmButtonText: "OK", confirmButtonAriaLabel: "", confirmButtonColor: null, confirmButtonClass: null, cancelButtonText: "Cancel", cancelButtonAriaLabel: "", cancelButtonColor: null, cancelButtonClass: null, buttonsStyling: !0, reverseButtons: !1, focusConfirm: !0, focusCancel: !1, showCloseButton: !1, closeButtonAriaLabel: "Close this dialog", showLoaderOnConfirm: !1, imageUrl: null, imageWidth: null, imageHeight: null, imageAlt: "", imageClass: null, timer: null, width: null, padding: null, background: null, input: null, inputPlaceholder: "", inputValue: "", inputOptions: {}, inputAutoTrim: !0, inputClass: null, inputAttributes: {}, inputValidator: null, grow: !1, position: "center", progressSteps: [], currentProgressStep: null, progressStepsDistance: null, onBeforeOpen: null, onOpen: null, onClose: null, useRejections: !1, expectRejections: !1 },
    ...
    return "function" == typeof e ? e() : e;
      ...
      d = { previousActiveElement: null, previousBodyPadding: null },
      p = function p(e, t) {
    ...
    return document.body.querySelector("." + o.container);
      ...
      k = function k(e) {
    var t = B();return t ? t.querySelector("." + e) : null;
  },
      S = function S() {
    return k(o.popup);
  },
    ...
    var e = Array.prototype.slice.call(S().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function (e, t) {
      return (e = parseInt(e.getAttribute("tabindex"))) > (t = parseInt(t.getAttribute("tabindex"))) ? 1 : e < t ? -1 : 0;
        ...
        t = Array.prototype.slice.call(S().querySelectorAll('button, input:not([type=hidden]), textarea, select, a, [tabindex="0"]'));return function (e) {
    ...
    return "undefined" == typeof window || "undefined" == typeof document;
      ...
      M = function M(e) {
    var t = B();if (t && (t.parentNode.removeChild(t), v([document.documentElement, document.body], [o["no-backdrop"], o["has-input"], o["toast-shown"]])), !D()) {
      var n = document.createElement("div");n.className = o.container, n.innerHTML = H, ("string" == typeof e.target ? document.querySelector(e.target) : e.target).appendChild(n);var i = S(),
          r = P(),
          a = h(r, o.input),
          u = h(r, o.file),
          ...
          f = h(r, o.textarea);i.setAttribute("role", e.toast ? "alert" : "dialog"), i.setAttribute("aria-live", e.toast ? "polite" : "assertive"), e.toast || i.setAttribute("aria-modal", "true");var m = function m() {
    ...
    return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e === "undefined" ? "undefined" : _typeof(e);
      ...
      W = function W(e, t) {
    if (!e) return y(t);if ("object" === (void 0 === e ? "undefined" : U(e))) {
      if (t.innerHTML = "", 0 in e) for (var n = 0; n in e; n++) {
        t.appendChild(e[n].cloneNode(!0));
      } else t.appendChild(e.cloneNode(!0));
    } else e && (t.innerHTML = e);b(t);
  },
      z = function () {
    if (D()) return !1;var e = document.createElement("div"),
    ...
    e.inputValidator || Object.keys(K).forEach(function (t) {
      ...
      l[c].style.backgroundColor = u;
        ...
        C = q(),
        k = I(),
        R = j();if (e.titleText ? p.innerText = e.titleText : e.title && (p.innerHTML = e.title.split("\n").join("<br />")), "string" == typeof e.backdrop ? B().style.background = e.backdrop : e.backdrop || g([document.documentElement, document.body], o["no-backdrop"]), e.html ? W(e.html, f) : e.text ? (f.textContent = e.text, b(f)) : y(f), e.position in o ? g(d, o[e.position]) : (a('The "position" parameter is not valid, defaulting to "center"'), g(d, o.center)), e.grow && "string" == typeof e.grow) {
      var N = "grow-" + e.grow;N in o && g(d, o[N]);
    }"function" == typeof e.animation && (e.animation = e.animation.call()), e.showCloseButton ? (k.setAttribute("aria-label", e.closeButtonAriaLabel), b(k)) : y(k), t.className = o.popup, e.toast ? (g([document.documentElement, document.body], o["toast-shown"]), g(t, o.toast)) : g(t, o.modal), e.customClass && g(t, e.customClass);var D = T(),
        H = parseInt(null === e.currentProgressStep ? ie.getQueueStep() : e.currentProgressStep, 10);e.progressSteps && e.progressSteps.length ? (b(D), w(D), H >= e.progressSteps.length && a("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), e.progressSteps.forEach(function (t, n) {
      var i = document.createElement("li");if (g(i, o.progresscircle), i.innerHTML = t, n === H && g(i, o.activeprogressstep), D.appendChild(i), n !== e.progressSteps.length - 1) {
        var r = document.createElement("li");g(r, o.progressline), e.progressStepsDistance && (r.style.width = e.progressStepsDistance), D.appendChild(r);
      }
    })) : y(D);for (var U = A(), z = 0; z < U.length; z++) {
      y(U[z]);
    }if (e.type) {
      var Z = !1;for (var _ in i) {
        if (e.type === _) {
          Z = !0;break;
        }
      }if (!Z) return s("Unknown alert type: " + e.type), !1;var Q = t.querySelector("." + o.icon + "." + i[e.type]);b(Q), e.animation && g(Q, "swal2-animate-" + e.type + "-icon");
    }var Y = L();if (e.imageUrl ? (Y.setAttribute("src", e.imageUrl), Y.setAttribute("alt", e.imageAlt), b(Y), e.imageWidth ? Y.setAttribute("width", e.imageWidth) : Y.removeAttribute("width"), e.imageHeight ? Y.setAttribute("height", e.imageHeight) : Y.removeAttribute("height"), Y.className = o.image, e.imageClass && g(Y, e.imageClass)) : y(Y), e.showCancelButton ? C.style.display = "inline-block" : y(C), e.showConfirmButton ? x(h, "display") : y(h), e.showConfirmButton || e.showCancelButton ? b(m) : y(m), h.innerHTML = e.confirmButtonText, C.innerHTML = e.cancelButtonText, h.setAttribute("aria-label", e.confirmButtonAriaLabel), C.setAttribute("aria-label", e.cancelButtonAriaLabel), h.className = o.confirm, g(h, e.confirmButtonClass), C.className = o.cancel, g(C, e.cancelButtonClass), e.buttonsStyling) {
      g([h, C], o.styled), e.confirmButtonColor && (h.style.backgroundColor = e.confirmButtonColor), e.cancelButtonColor && (C.style.backgroundColor = e.cancelButtonColor);var $ = window.getComputedStyle(h).getPropertyValue("background-color");h.style.borderLeftColor = $, h.style.borderRightColor = $;
    } else v([h, C], o.styled), h.style.backgroundColor = h.style.borderLeftColor = h.style.borderRightColor = "", C.style.backgroundColor = C.style.borderLeftColor = C.style.borderRightColor = "";W(e.footer, R), !0 === e.animation ? v(t, o.noanimation) : g(t, o.noanimation), e.showLoaderOnConfirm && !e.preConfirm && a("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request");
  }var _ = Object.freeze({ cancel: "cancel", backdrop: "overlay", close: "close", esc: "esc", timer: "timer" }),
      Q = function Q() {
    ...
    for (var t = 1; t < arguments.length; t++) {
      ...
      ne = function ne(e) {
    for (var t in e) {
      ie.isValidParameter(t) || a('Unknown parameter "' + t + '"'), ie.isDeprecatedParameter(t) && l('The parameter "' + t + '" is deprecated and will be removed in the next major release.');
    }
  },
      oe = function oe(e, t, n) {
    var i = B(),
        r = S();null !== t && "function" == typeof t && t(r), e ? (g(r, o.show), g(i, o.fade), v(r, o.hide)) : v(r, o.fade), b(r), i.style.overflowY = "hidden", z && !p(r, o.noanimation) ? r.addEventListener(z, function e() {
      ...
      if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !p(document.body, o.iosfix)) {
        var e = document.body.scrollTop;document.body.style.top = -1 * e + "px", g(document.body, o.iosfix);
      }
    ...
    for (var t = arguments.length, n = Array(t), i = 0; i < t; i++) {
      ...
      if ("undefined" == typeof Promise && s("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), void 0 === n[0]) return s("SweetAlert2 expects at least 1 attribute!"), !1;var r = G = {},
          a = r.params = F({}, J, e.argsToParams(n));Z(a);var u = r.domCache = { popup: S(), container: B(), content: P(), actions: V(), confirmButton: O(), cancelButton: q(), closeButton: I(), validationError: k(o.validationerror), progressSteps: T() };return new Promise(function (t, n) {
        var i = function i(n) {
          e.closePopup(a.onClose), a.useRejections ? t(n) : t({ value: n });
        },
            r = function r(o) {
          ...
          var t = e.getInput();t && f(t);
        }, 0);for (var d = function d(t) {
          if (a.showLoaderOnConfirm && e.showLoading(), a.preConfirm) {
            e.resetValidationError();var n = Promise.resolve().then(function () {
          ...
          var n = t || window.event,
              ...
              p = s && (s === o || s.contains(o));switch (n.type) {case "click":
              if (c && e.isVisible()) {
                if (e.disableButtons(), a.input) {
                  var f = function () {
                    var t = e.getInput();if (!t) return null;switch (a.input) {case "checkbox":
                    ...
                    e.disableInput();var m = Promise.resolve().then(function () {
        ...
        }, m = u.popup.querySelectorAll("button"), v = 0; v < m.length; v++) {
          m[v].onclick = p, m[v].onmouseover = p, m[v].onmouseout = p, m[v].onmousedown = p;
          ...
          var w = !1;u.popup.onmousedown = function () {
        ...
        }a.reverseButtons ? u.confirmButton.parentNode.insertBefore(u.cancelButton, u.confirmButton) : u.confirmButton.parentNode.insertBefore(u.confirmButton, u.cancelButton);var x = function x(e, t) {
          for (var n = R(a.focusCancel), o = 0; o < n.length; o++) {
            (e += t) === n.length ? e = 0 : -1 === e && (e = n.length - 1);var i = n[e];if (C(i)) return i.focus();
          }
        };a.toast && te && (window.onkeydown = ee, te = !1), a.toast || te || (ee = window.onkeydown, te = !0, window.onkeydown = function (t) {
          var n = t || window.event;if ("Enter" !== n.key || n.isComposing) {
            if ("Tab" === n.key) {
            ...
            if (-1 !== ["textarea", "file"].indexOf(a.input)) return;e.clickConfirm(), n.preventDefault();
          }
        }), e.enableButtons(), e.hideLoading(), e.resetValidationError(), a.input && g(document.body, o["has-input"]);for (var B = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], k = void 0, S = 0; S < B.length; S++) {
          var A = o[B[S]],
              E = h(u.content, A);if (k = e.getInput(B[S])) {
            for (var P in k.attributes) {
              if (k.attributes.hasOwnProperty(P)) {
                var L = k.attributes[P].name;"type" !== L && "value" !== L && k.removeAttribute(L);
              }
            }for (var T in a.inputAttributes) {
              k.setAttribute(T, a.inputAttributes[T]);
            }
          }E.className = A, a.inputClass && g(E, a.inputClass), y(E);
        }var O = void 0;switch (a.input) {case "text":case "email":case "password":case "number":case "tel":case "url":
            (k = h(u.content, o.input)).value = a.inputValue, k.placeholder = a.inputPlaceholder, k.type = a.input, b(k);break;case "file":
            (k = h(u.content, o.file)).placeholder = a.inputPlaceholder, k.type = a.input, b(k);break;case "range":
            var q = h(u.content, o.range),
                V = q.querySelector("input"),
                j = q.querySelector("output");V.value = a.inputValue, V.type = a.input, j.value = a.inputValue, b(q);break;case "select":
            var I = h(u.content, o.select);if (I.innerHTML = "", a.inputPlaceholder) {
              var N = document.createElement("option");N.innerHTML = a.inputPlaceholder, N.value = "", N.disabled = !0, N.selected = !0, I.appendChild(N);
            }O = function O(e) {
              e.forEach(function (e) {
                var t = $(e, 2),
                    n = t[0],
                    o = t[1],
                    i = document.createElement("option");i.value = n, i.innerHTML = o, a.inputValue.toString() === n.toString() && (i.selected = !0), I.appendChild(i);
              }), b(I), I.focus();
            };break;case "radio":
            var D = h(u.content, o.radio);D.innerHTML = "", O = function O(e) {
              e.forEach(function (e) {
                var t = $(e, 2),
                    n = t[0],
                    i = t[1],
                    r = document.createElement("input"),
                    s = document.createElement("label");r.type = "radio", r.name = o.radio, r.value = n, a.inputValue.toString() === n.toString() && (r.checked = !0), s.innerHTML = i, s.insertBefore(r, s.firstChild), D.appendChild(s);
              }), b(D);var t = D.querySelectorAll("input");t.length && t[0].focus();
            };break;case "checkbox":
            var H = h(u.content, o.checkbox),
                M = e.getInput("checkbox");M.type = "checkbox", M.value = 1, M.id = o.checkbox, M.checked = Boolean(a.inputValue);var U = H.getElementsByTagName("span");U.length && H.removeChild(U[0]), (U = document.createElement("span")).innerHTML = a.inputPlaceholder, H.appendChild(U), b(H);break;case "textarea":
            var W = h(u.content, o.textarea);W.value = a.inputValue, W.placeholder = a.inputPlaceholder, b(W);break;case null:
            break;default:
            s('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "' + a.input + '"');}if ("select" === a.input || "radio" === a.input) {
          var z = function z(e) {
      ...
      v(n, o.show), g(n, o.hide), clearTimeout(n.timeout), document.body.classList.contains(o["toast-shown"]) || (!function () {
        if (d.previousActiveElement && d.previousActiveElement.focus) {
          var e = window.scrollX,
              t = window.scrollY;d.previousActiveElement.focus(), void 0 !== e && void 0 !== t && window.scrollTo(e, t);
        }
      }(), window.onkeydown = ee, te = !1);var i = function i() {
        t.parentNode && t.parentNode.removeChild(t), v([document.documentElement, document.body], [o.shown, o["no-backdrop"], o["has-input"], o["toast-shown"]]), N() && (null !== d.previousBodyPadding && (document.body.style.paddingRight = d.previousBodyPadding, d.previousBodyPadding = null), function () {
          if (p(document.body, o.iosfix)) {
            var e = parseInt(document.body.style.top, 10);v(document.body, o.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * e;
          }
        }());
    ...
    var e = S();e || ie(""), e = S();var t = V(),
        n = O(),
        i = q();b(t), b(n), g([e, t], o.loading), n.disabled = !0, i.disabled = !0, e.setAttribute("data-loading", !0), e.setAttribute("aria-busy", !0), e.focus();
    ...
    if (!e || "object" !== (void 0 === e ? "undefined" : Y(e))) return s("the argument for setDefaults() is required and has to be a object");for (var t in ne(e), e) {
      ie.isValidParameter(t) && (J[t] = e[t]);
    }
    ...
    if (G) {
      var e = G,
          t = e.params,
          n = e.domCache;t.showConfirmButton || (y(n.confirmButton), t.showCancelButton || y(n.actions)), v([n.popup, n.actions], o.loading), n.popup.removeAttribute("aria-busy"), n.popup.removeAttribute("data-loading"), n.confirmButton.disabled = !1, n.cancelButton.disabled = !1;
    }
  }, ie.getInput = function (e) {
    if (G) {
      var t = G,
          n = t.params,
          i = t.domCache;if (!(e = e || n.input)) return null;switch (e) {case "select":case "textarea":case "file":
          return h(i.content, o[e]);case "checkbox":
          return i.popup.querySelector("." + o.checkbox + " input");case "radio":
          return i.popup.querySelector("." + o.radio + " input:checked") || i.popup.querySelector("." + o.radio + " input:first-child");case "range":
          return i.popup.querySelector("." + o.range + " input");default:
          return h(i.content, o.input);}
    }
  }, ie.enableButtons = function () {
    if (G) {
      var e = G.domCache;e.confirmButton.disabled = !1, e.cancelButton.disabled = !1;
    }
  }, ie.disableButtons = function () {
    if (G) {
      var e = G.domCache;e.confirmButton.disabled = !0, e.cancelButton.disabled = !0;
    }
    ...
    if (G) {
      var e = ie.getInput();if (!e) return !1;if ("radio" === e.type) for (var t = e.parentNode.parentNode.querySelectorAll("input"), n = 0; n < t.length; n++) {
        t[n].disabled = !1;
      } else e.disabled = !1;
    }
  }, ie.disableInput = function () {
    if (G) {
      var e = ie.getInput();if (!e) return !1;if (e && "radio" === e.type) for (var t = e.parentNode.parentNode.querySelectorAll("input"), n = 0; n < t.length; n++) {
        t[n].disabled = !0;
      } else e.disabled = !0;
    }
  }, ie.showValidationError = function (e) {
    if (G) {
      var t = G.domCache;t.validationError.innerHTML = e;var n = window.getComputedStyle(t.popup);t.validationError.style.marginLeft = "-" + n.getPropertyValue("padding-left"), t.validationError.style.marginRight = "-" + n.getPropertyValue("padding-right"), b(t.validationError);var i = ie.getInput();i && (i.setAttribute("aria-invalid", !0), i.setAttribute("aria-describedBy", o.validationerror), f(i), g(i, o.inputerror));
    }
  }, ie.resetValidationError = function () {
    if (G) {
      var e = G.domCache;e.validationError && y(e.validationError);var t = ie.getInput();t && (t.removeAttribute("aria-invalid"), t.removeAttribute("aria-describedBy"), v(t, o.inputerror));
    }
  }, ie.getProgressSteps = function () {
    if (G) return G.params.progressSteps;
  }, ie.setProgressSteps = function (e) {
    if (G) {
      var t = G.params;t.progressSteps = e, Z(t);
    }
  }, ie.showProgressSteps = function () {
    if (G) {
      var e = G.domCache;b(e.progressSteps);
    }
  }, ie.hideProgressSteps = function () {
    if (G) {
      var e = G.domCache;y(e.progressSteps);
    }
  }, ie.argsToParams = function (e) {
    var t = {};switch (Y(e[0])) {case "string":
        ["title", "html", "type"].forEach(function (n, o) {
          void 0 !== e[o] && (t[n] = e[o]);
        });break;case "object":
        ne(e[0]), F(t, e[0]);break;default:
        return s('Unexpected type of argument! Expected "string" or "object", got ' + Y(e[0])), !1;}return t;
